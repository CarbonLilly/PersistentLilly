...
/datum/machine_limits
	...
	var/limit_genfab = 99999999
	var/list/genfabs = list()
	var/limit_engfab = 99999999
	var/list/engfabs = list()
	var/limit_medicalfab = 99999999
	var/list/medicalfabs = list()
	var/limit_mechfab = 99999999
	var/list/mechfabs = list()
	var/limit_voidfab = 99999999
	var/list/voidfabs = list()
	var/limit_ataccessories = 99999999
	var/list/ataccessories = list()
	var/limit_atnonstandard = 99999999
	var/list/atnonstandards = list()
	var/limit_atstandard = 99999999
	var/list/atstandards = list()
	var/limit_ammofab = 99999999
	var/list/ammofabs = list()
	var/limit_consumerfab = 99999999
	var/list/consumerfabs = list()
	var/limit_servicefab = 99999999
